              ...
              <div className="flex flex-wrap gap-3">
                {items.map((item, i) => (
                  <motion.div
                    ...
                    className="rounded-lg border border-border bg-card/60 px-4 py-2.5 text-sm text-foreground hover:border-primary/50 hover:shadow-[0_0_25px_hsl(30_100%_60%/0.15)] hover:text-primary transition-all duration-300 cursor-default"
                    data-hoverable
                  >
                    {item}
                  </motion.div>
